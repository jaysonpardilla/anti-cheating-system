...
import { FaTachometerAlt, FaExclamationTriangle, FaFolderOpen, FaVideo, FaFileAlt, FaEdit, FaUser, FaCog, FaQuestionCircle, FaSignOutAlt } from 'react-icons/fa';
  ...
  <div className="profile-container">
    ...
    <div className="main-content">
      <div className="profile-card">
        ...
        <p><b>Subject exam:</b> {profile.subject_exam}</p>
